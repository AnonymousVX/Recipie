...
void LCD_display(unsigned int row, unsigned int pos, unsigned char
*ch)
{
if(row==1)
...
ADCON1 = 0b00000111; //Ref voltages Vdd & Vss; AN0
- AN7 channels Analog
ADCON2 = 0b10101110; //Right justified; Acquisition
time 4T; Conversion clock Fosc/64
}
